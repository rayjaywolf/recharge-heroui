...
export default async function DistributorNotificationsPage() {
  ...
  const balanceNotifications: DistributorNotification[] = credits.map((credit) => ({
  ...
  const rechargeNotifications: DistributorNotification[] = rechargeUpdates.map(
    (recharge) => ({
  ...
  const notifications: DistributorNotification[] = [
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Distributor Notifications</CardTitle>
          <CardDescription>
