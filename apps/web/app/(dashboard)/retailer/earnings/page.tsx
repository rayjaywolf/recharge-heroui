    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-muted">
          Commissions from your successful recharges.
        </p>
      </div>
        ...
        {rows.length === 0 ? (
          ...
          <Table>
            <Table.ScrollContainer className="max-h-[min(70vh,720px)]">
              <Table.Content aria-label="Retailer earnings" className="min-w-[760px]">
                <Table.Header>
                  ...
                  {rows.map((tx) => (
                    <Table.Row key={tx.id} className="whitespace-nowrap">
                      ...
                      <Table.Cell className="text-right font-semibold">
                        <Money amount={tx.commission} className="text-success" sign="+" />
                      </Table.Cell>
                    </Table.Row>
                  ))}
                </Table.Body>
