...
export function DistributorLedgerTable({
  transactions,
}: {
  ...
  if (transactions.length === 0) {
    return (
      <AdminTableEmpty message="No ledger history records found." />
    );
  }
              ...
              {transactions.map((tx) => (
                ...
                >
                  ...
                  <Table.Cell>
                    ...
                    >
                      <TransactionPdfDownloadButton mode="distributor" transaction={tx} />
                    </div>
                  </Table.Cell>
                </Table.Row>
              ))}
