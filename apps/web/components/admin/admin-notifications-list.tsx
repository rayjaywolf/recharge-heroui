    ...
    <div className="space-y-4">
      ...
      {items.length === 0 ? (
        <p className="rounded-3xl bg-surface px-5 py-8 text-center text-sm text-muted">
          No notifications yet. You will be notified when retailers apply or
          disputes are opened.
        </p>
      ) : visibleItems.length === 0 ? (
        <p className="rounded-3xl bg-surface px-5 py-8 text-center text-sm text-muted">
          {activeTab === "unread"
            ? "All caught up. Switch to Read to see older notifications."
            : "No read notifications. Items you mark as read appear here."}
        </p>
      ) : (
